<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Forum.aspx.cs" Inherits="All_Liberia.Forum" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <ul class="digimeg-nav-down-content digimeg-sub-nav" style="z-index: 200; margin-top: 0;">
            ...
            <li id="his-subnav">
                <div class="digimeg-nav-item-content digimeg-group">
                    ...
                    <p>
                        <img src="Content/Images/Presidents/Joseph_Jenkins_Roberts.jpg" style="float:left; width:200px; height:230px; margin-right:10px;" title="Joseph Jenkin Roberts" />
    ...
    <iframe src="http://forum.all-liberia.com/index.php"  seamless="seamless" scrolling="no" style="border-radius:8px; width:100%; height:600px"></iframe>
